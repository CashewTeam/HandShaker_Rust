...
extension HandShakerRuntime {
    ...
    public func syncPlan(sessionID: UInt64, profile: SyncProfile) throws -> SyncPlan {
    ...
    public func syncStart(sessionID: UInt64, profile: SyncProfile) throws -> String {
        let body = try ServicesJSON.encode(profile)
    ...
    public func syncStatus(profileID: String) throws -> SyncStatus {
    ...
    public func syncStop(profileID: String) throws {
        try handle.withRuntime { runtime in
            try withHsString(profileID) { ptr, len in
    ...
    public func syncStartWatch(profileID: String) throws {
        try handle.withRuntime { runtime in
            try withHsString(profileID) { ptr, len in
    ...
    public func syncStopWatch(profileID: String) throws {
        try handle.withRuntime { runtime in
            try withHsString(profileID) { ptr, len in
