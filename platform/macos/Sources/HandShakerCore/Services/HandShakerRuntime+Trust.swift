...
extension HandShakerRuntime {
    ...
    /// request body).
    public func trustList() async throws -> [TrustRecord] {
    ...
    public func trustRemove(deviceID: DeviceID) async throws {
    ...
    public func trustReset(endpoint: String, expectedDeviceID: DeviceID) async throws {
